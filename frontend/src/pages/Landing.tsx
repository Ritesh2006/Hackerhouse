...
import { Search, MapPin, Code2, ArrowRight, Zap, Globe, Navigation, Terminal, Sparkles, Shield, Cpu, ExternalLink, CheckCircle } from 'lucide-react';
...
function StepItem({ num, title, desc, icon: Icon }: any) {
  return (
    <div className="relative p-6 sm:p-8 rounded-[1.5rem] border border-white/5 bg-white/[0.01] hover:bg-white/[0.02] hover:border-white/10 transition-all group">
      <div className="absolute top-4 right-4 text-[40px] font-black text-white/[0.02] font-mono leading-none group-hover:text-indigo-500/5 transition-all">{num}</div>
      <div className="w-10 h-10 rounded-xl bg-indigo-500/5 border border-indigo-500/10 flex items-center justify-center text-indigo-400 mb-5">
        <Icon size={16} />
      </div>
...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden relative" style={{ background: '#050914' }}>
      
      {/* Background visual components */}
      <Orb style={{ width: 600, height: 600, top: '-15%', left: '-10%', background: '#6366f1' }} delay={0} />
      <Orb style={{ width: 500, height: 500, top: '30%', right: '-15%', background: '#818cf8' }} delay={3} />
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 w-full relative z-10 items-center">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <motion.div
              ...
              className="glass rounded-2xl p-2.5 flex flex-col sm:flex-row gap-2.5 max-w-2xl relative z-20 border border-white/8 hover:border-indigo-500/20 focus-within:border-indigo-500/30 transition-all shadow-2xl"
          ...
          <div className="lg:col-span-5 relative order-first lg:order-last flex items-center justify-center">
            ...
            >
              ...
              <img src="/hero_vector.png" alt="Global Network of Developers" className="relative z-10 w-full h-auto drop-shadow-2xl animate-float rounded-2xl" />
            </motion.div>
          </div>
      ...
      {/* ── HOW IT WORKS ─────────────────────────────── */}
      <section className="py-24 px-4 bg-[#050914] relative z-10 border-t border-white/5 overflow-hidden">
      ...
      {/* ── TESTIMONIALS ─────────────────────────────── */}
      <section className="py-24 px-4 bg-[#050914] relative z-10 border-t border-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-xl mx-auto mb-16 space-y-2">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-white/[0.02] border border-white/5 rounded-xl text-indigo-400 text-[10px] font-bold uppercase tracking-widest">
      ...
      {/* ── FINAL CTA ────────────────────────────────── */}
      <section className="py-24 px-4 relative z-10 bg-[#050914] border-t border-white/5">
